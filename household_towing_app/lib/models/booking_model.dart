...
class Booking {
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      'selectedSubServices': selectedSubServices != null ? Map<String, dynamic>.from(selectedSubServices!) : null,
      'serviceDetails': serviceDetails != null ? Map<String, dynamic>.from(serviceDetails!) : null,
      'barangay': barangay,
      'zone': zone,
      ...
      'assignedPersonnelIds': List<String>.from(assignedPersonnelIds),
      'assignedAssets': Map<String, dynamic>.from(assignedAssets),
      'assignedTruckName': assignedTruckName,
      'assignedPersonnelNames': List<String>.from(assignedPersonnelNames),
